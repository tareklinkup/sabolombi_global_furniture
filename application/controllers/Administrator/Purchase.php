...
class Purchase extends CI_Controller
{
    ...
    public function addPurchase()
    {
        ...
        try {
            ...
            $purchase = array(
                ...
                'PurchaseMaster_MemoNo'         => $data->purchase->memo_no,
            ...
            // if ($data->purchase->paid > 0 && $data->purchase->payment_method == 'Bank') {
            //     $transaction        = [];

            //     $transaction['account_id']       = $data->purchase->bank_name;
            //     $transaction['transaction_date'] = date('Y-m-d');
            //     $transaction['transaction_type'] = 'withdraw';
            //     $transaction['amount']           = $data->purchase->paid;
            //     $transaction['note']             = 'Payment to supplier for product purchase';
            ...
            //     $transaction['trans_id']         = $purchaseId;
    ...
    public function updatePurchase()
    {
        ...
        try {
            ...
            //     $this->db->set(['amount' => $data->purchase->paid, 'account_id' => $data->purchase->bank_name, 'transaction_date' => date('Y-m-d')])->where(['trans_id' => $purchaseId, 'transaction_type' => 'withdraw'])->update('tbl_bank_transactions');
            // }
    ...
    public function  deletePurchase()
    {
        ...
        try {
            ...
            // $this->db->query("update tbl_bank_transactions set status = 0 where trans_id = ? and transaction_type = 'withdraw'", $data->purchaseId);
