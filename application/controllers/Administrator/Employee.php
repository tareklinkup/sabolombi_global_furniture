...
class Employee extends CI_Controller
{
    ...
    public function employee_insert()
    {
        ...
        if ($_FILES['attached_file']) {
            $filename  = $_FILES['attached_file']['name'];
            $arr       = explode('.', $filename);
            $extension = end($arr);
            $newName   = $employee_code . '.' . $extension;
            move_uploaded_file($_FILES["attached_file"]["tmp_name"], 'uploads/documentFile/' . $newName);
        }
        ...
        $data['Employee_Document'] = $newName;
