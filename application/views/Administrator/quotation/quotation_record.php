...
<div id="quotationRecord">
    <div class="row" style="border-bottom: 1px solid #ccc;padding: 3px 0;">
        <div class="col-md-12">
            <form class="form-inline" id="searchForm" @submit.prevent="getSearchResult">
                ...
                <div class="form-group" style="display:none;"
                    v-bind:style="{display: searchType == 'user' ? '' : 'none'}">
                    <label>User</label>
    ...
    <div class="row" style="margin-top:15px;display:none;"
        ...
        <div class="col-md-12" style="display:none;"
            v-bind:style="{display: quotations.length > 0 && searchTypesForRecord.includes(searchType) && recordType == 'without_details' ? '' : 'none'}">
        ...
        <div v-if="searchTypesForRecord.includes(searchType)" class="col-md-12" style="display:none;"
            v-bind:style="{display: quotations.length > 0 && searchTypesForRecord.includes(searchType) && recordType == 'with_details' ? '' : 'none'}">
            <div class="table-responsive" id="reportContent">
                <table class="record-table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <template v-for="quote in quotations">
                            <tr>
                                ...
                                <td>{{ quote.quotationDetails[0].color_name ? quote.quotationDetails[0].color_name : '-'  }}
                                </td>
                                <td>{{ quote.quotationDetails[0].size ? quote.quotationDetails[0].size : '-'  }}</td>
                                <td style="text-align:right;">{{ quote.quotationDetails[0].SaleDetails_Rate }}</td>
                                <td style="text-align:center;">{{ quote.quotationDetails[0].SaleDetails_TotalQuantity }}
                                </td>
                                <td style="text-align:right;">{{ quote.quotationDetails[0].SaleDetails_TotalAmount }}
                                </td>
                                <td style="text-align:center;">
                            ...
                            <tr style="font-weight:bold;">
                                <td colspan="6" style="font-weight:normal;"><strong>Note:
                                    </strong>{{ quote.SaleMaster_Description }}</td>
                                <td colspan="2" style="text-align: right; font-weight:bold">Total = </td>
                                <td style="text-align:center;">
                                    {{ quote.quotationDetails.reduce((prev, curr) => {return prev + parseFloat(curr.SaleDetails_TotalQuantity)}, 0) }}
                                </td>
        ...
        <div class="col-md-12" style="display:none;"
            v-bind:style="{display: quotations.length > 0 && searchTypesForDetails.includes(searchType) ? '' : 'none'}">
            <div class="table-responsive" id="reportContent">
                <table class="record-table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <template v-for="quote in quotations">
                            <tr>
                                <td colspan="3" style="text-align:center;background: #ccc;">{{ quote.category_name }}
                                </td>
                            </tr>
