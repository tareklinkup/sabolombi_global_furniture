	...
	<div class="row">
		...
		<div class="form-horizontal">
			...
			<div class="col-sm-6">
				...
				<div class="form-group">
					<label class="col-sm-4 control-label" for="em_photo"> Document File (.pdf)</label>
					<label class="col-sm-1 control-label">:</label>
					<div class="col-sm-6">
						<input type="file" id="attached_file" name="attached_file" class="form-control" style="height:35px" />
					</div>
				</div>
