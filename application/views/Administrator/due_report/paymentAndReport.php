...
$totalDue = $type == 'CR' ? $prevdueAmont - $CPROW->CPayment_amount - $CPROW->CPayment_discount : $prevdueAmont + $CPROW->CPayment_amount + $CPROW->CPayment_discount;
                ...
                <table class="border" cellspacing="0" cellpadding="0" style="width: 100%;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align:right;"><?php echo $CPROW->CPayment_discount; ?></td>
        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-12 text-left;">
                <table style="width: 25%;float:left;">
                    ...
                    <tr>
                        <td style="font-size: 13px; font-weight: 600; border-bottom: 2px solid #000; ">Charge/Less : </td>
