...
<div id="graph">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <h3 class="text-center">Top Production</h3>
            <top-production
            type="PieChart"
            :data="topProductions"
            :options="topProductionsOptions"
            />
        </div>
        <div class="col-md-4">
        ...
        methods: {
            getGraphData(){
                axios.get('/get_graph_data').then(res => {
                    ...
                    res.data.top_productions.forEach(p => {
                        this.topProductions.push([p.product_name, parseFloat(p.quantity)]);
                    })
