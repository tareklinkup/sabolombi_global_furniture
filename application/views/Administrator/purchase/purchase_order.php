	...
	new Vue({
		...
		methods: {
			...
			calculateTotal() {
				...
				this.purchase.total = ((parseFloat(this.purchase.subTotal) + parseFloat(this.purchase.vat)) - parseFloat(this.purchase.discount) + parseFloat(this.purchase.freight)).toFixed(2);
