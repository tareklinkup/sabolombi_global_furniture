										...
										<td>
											<div class="row" style="margin: 0px 9px 5px;">
												<div class="col-md-6 no-padding-left">
													<input type="radio" id="shipping_due" name="shipping" value="1" v-model="sales.shipping_due"> <label for="shipping_due">Shipping Due </label>
												</div>
												<div class="col-md-6 no-padding-right">
													<input type="radio" id="shipping_paid" name="shipping" value="1" v-model="sales.shipping_paid">
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-xs-7">
													<input type="number" id="aitCostPercent" class="form-control" v-model="aitCostPercent" v-on:input="calculateTotal" />
												</div>
											</div>
										</td>
									</tr>
		...
		methods: {
			...
			calculateTotal() {
				...
				if (event.target.id == 'aitCostPercent') {
					this.sales.aitCost = ((parseFloat(this.sales.subTotal) * parseFloat(this.aitCostPercent)) / 100).toFixed(2);
				} else {
					this.aitCostPercent = (parseFloat(this.sales.aitCost) / parseFloat(this.sales.subTotal) * 100).toFixed(2);
				}
