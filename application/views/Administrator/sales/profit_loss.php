			...
			<div class="table-responsive" id="reportTable">
				<table id="table1">
					...
					<tfoot style="font-weight:bold;background-color:#e9dcdc;">
						...
						<tr>
							<td colspan="4" style="text-align:right;">Charge/Less (-)</td>
							<td colspan="2"></td>
						...
						<tr>
							<td colspan="4" style="text-align:right;">Bad Debt (-)</td>
							<td colspan="2"></td>
