...
<script type="text/javascript">
    function submit(){
        ...
        var urldata = "<?php echo base_url();?>Administrator/page/matcatupdate";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
            success:function(data){
				...
				window.location = '/material_category';
            }
        });
    }
</script>
<script type="text/javascript">
    function deleted(id){
        ...
        //alert(inputdata);
        var urldata = "<?php echo base_url();?>Administrator/page/materialCatDelete";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
