    ...
    <form @submit.prevent="saveProduct">
        <div class="row"
            ...
            <div class="col-md-5">
                ...
                <div class="form-group clearfix">
                    <label class="control-label col-md-4">Colour:</label>
                    <div class="col-md-7">
                        ...
                        <v-select v-bind:options="colors" v-model="selectedColor" label="color_name"
                            v-if="colors.length > 0"></v-select>
                    </div>
                    <div class="col-md-1" style="padding:0;margin-left: -15px;"><a href="/color" target="_blank"
                            class="add-button"><i class="fa fa-plus"></i></a></div>
                </div>
                <div class="form-group clearfix">
