                            ...
                            <div class="col-sm-12">
                                <form id="productForm" v-on:submit.prevent="addToProductCart">
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" required class="form-control" placeholder="Pur. Rate" v-model="unit_price" readonly />
                                        </div>
                                    </div>
                                    <!-- <div class="form-group clearfix">
                    ...
                    <table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
                        <thead>
                            <tr>
                                ...
                                <th style="width:5%;color:#000;">Qty</th>
                                <th style="width:5%;color:#000;">Unit Price</th>
                                <!-- <th style="width:5%;color:#000;">Amount</th> -->
                                <th style="width:10%;color:#000;">Action</th>
                            </tr>
                        </thead>
    ...
    new Vue({
        ...
        methods: {
            ...
            calculateProductTotal() {
                this.unit_price = this.production.total_cost / this.selectedProduct.quantity;
                // this.selectedProduct.total = this.selectedProduct.quantity * this.selectedProduct.Product_Purchase_Rate;
            },
            addToProductCart() {

                if (this.production.labour_cost == '') {
                    alert('labour Cost is Empty');
                    return;
                }
                if (this.production.other_cost == '') {
                    alert('Other Cost is Empty');
                    return;
                }
            ...
            calculateTotal() {
                ...
                this.production.total_cost =
                    parseFloat(this.production.labour_cost == '' ? 0 : this.production.labour_cost) +
                    parseFloat(this.production.material_cost) +
                    parseFloat(this.production.other_cost == '' ? 0 : this.production.other_cost);
